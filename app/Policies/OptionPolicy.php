...
class OptionPolicy
{
    ...
    {
        return $user->hasPermission('option-view-any');
    }
    ...
    {
        return $user->hasPermission('option-view');
    }
    ...
    {
        return $user->hasPermission('option-create');
    }
    ...
    {
        return $user->hasPermission('option-update');
    }
    ...
    {
        return $user->hasPermission('option-delete');
    }
