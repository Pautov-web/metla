...
@section('url', route('admin.users.update', ['user' => $user->id]))
@section('url-destroy', route('admin.users.destroy', ['user' => $user->id]))
...
@section('form')
	...
	<div class="card">
		...
		<div class="card-body">
			<input type="text" name="name" id="name" value="{{ $user->name ?? '' }}" class="form-control" placeholder="{{ __('Виктор') }}">
		</div>
	</div>
	<div class="card" data-role="2">
		...
		<div class="card-body">
			<input type="text" name="surname" id="surname" value="{{ $user->surname ?? '' }}" class="form-control" placeholder="{{ __('Симонов') }}">
		</div>
	</div>
	<div class="card" data-role="2">
		<div class="card-header">
		...
		<div class="card-body">
			<input type="text" name="patronymic" id="patronymic" value="{{ $user->patronymic ?? '' }}" class="form-control" placeholder="{{ __('Александрович') }}">
		</div>
	</div>
	<div class="card">
		<div class="card-header">
		...
		<div class="card-body">
			<input type="email" name="email" id="email" value="{{ $user->email ?? '' }}" class="form-control" placeholder="{{ __('mail@mail.mail') }}">
		</div>
	</div>
	<div class="card">
		<div class="card-header">
		...
		<div class="card-body">
			<input type="tel" name="phone" id="phone" value="{{ $user->phone ?? '' }}" class="form-control" placeholder="">
		</div>
	</div>
	<div class="card" data-role="2">
		<div class="card-header">
		...
		<div class="card-body">
			<input type="date" name="date_of_birth" value="{{ $user->date_of_birth ?? '' }}" id="date_of_birth" class="form-control" placeholder="">
		</div>
	</div>
	<div class="card" data-role="2">
		<div class="card-header">
	...
	<div class="card" data-role="2">
		...
		<div class="card-body">
			<input type="number" name="passport_series" id="passport_series" value="{{ $user->passport_series ?? '' }}" class="form-control" placeholder="">
		</div>
	</div>
	<div class="card" data-role="2">
		<div class="card-header">
		...
		<div class="card-body">
			<input type="number" name="passport_number" id="passport_number" value="{{ $user->passport_number ?? '' }}" class="form-control" placeholder="">
		</div>
	</div>
	<div class="card" data-role="2">
		<div class="card-header">
		...
		<div class="card-body">
			<input type="date" name="passport_date" id="passport_date" value="{{ $user->passport_date ?? '' }}" class="form-control" placeholder="">
		</div>
	</div>
	<div class="card" data-role="2">
		<div class="card-header">
		...
		<div class="card-body">
			<textarea name="passport_address" id="passport_address" class="form-control" rows="2">{{ $user->passport_address ?? '' }}</textarea>
		</div>
	</div>
	<div class="card" data-role="2">
		<div class="card-header">
	...
	<div class="card" data-role="2">
		...
		<div class="card-body">
			<input type="text" name="bank_number" value="{{ $user->bank_number ?? '' }}" id="bank_number" class="form-control" placeholder="">
		</div>
	</div>
	<div class="card" data-role="2">
		<div class="card-header">
		...
		<div class="card-body">
			<input type="text" name="bank_bic" value="{{ $user->bank_bic ?? '' }}" id="bank_bic" class="form-control" placeholder="">
		</div>
	</div>
	<div class="card" data-role="2">
		<div class="card-header">
		...
		<div class="card-body">
			<input type="text" name="bank_name" value="{{ $user->bank_name ?? '' }}" id="bank_name" class="form-control" placeholder="">
		</div>
	</div>
	<div class="card" data-role="2">
		<div class="card-header">
